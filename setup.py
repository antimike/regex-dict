...
setup(
    ...
    name="reference_scraper",  # Required
    ...
    description="A collection of tools for scraping academic references from websites",  # Optional
    ...
    # above.
    author_email="antihaynes@gmail.com",  # Optional
    ...
    classifiers=[  # Optional
        ...
        "Intended Audience :: Academic researchers and deveopers",
        "Topic :: Research :: Reference Management",
    ...
    keywords="citation-management bibliography webscraper academic-references",  # Optional
